using Venly.Template.Application.Features.Accounts.Commands;
using Venly.Template.Application.Features.Accounts.Queries;
using Microsoft.AspNetCore.Mvc;
using Venly.Dispatch.Interfaces;
using Venly.Template.API.Requests.Accounts;

namespace Venly.Template.API.Controllers;
